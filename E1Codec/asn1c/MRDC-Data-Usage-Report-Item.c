...
asn_TYPE_member_t asn_MBR_MRDC_Data_Usage_Report_Item_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MRDC_Data_Usage_Report_Item, startTimeStamp),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MRDC_Data_Usage_Report_Item, endTimeStamp),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MRDC_Data_Usage_Report_Item, usageCountUL),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MRDC_Data_Usage_Report_Item, usageCountDL),
	...
	{ ATF_POINTER, 1, offsetof(struct MRDC_Data_Usage_Report_Item, iE_Extensions),
...
static const int asn_MAP_MRDC_Data_Usage_Report_Item_oms_1[] = { 4 };
static const ber_tlv_tag_t asn_DEF_MRDC_Data_Usage_Report_Item_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MRDC_Data_Usage_Report_Item_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_MRDC_Data_Usage_Report_Item_specs_1 = {
	sizeof(struct MRDC_Data_Usage_Report_Item),
	offsetof(struct MRDC_Data_Usage_Report_Item, _asn_ctx),
	asn_MAP_MRDC_Data_Usage_Report_Item_tag2el_1,
	5,	/* Count of tags in the map */
	asn_MAP_MRDC_Data_Usage_Report_Item_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	5,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_MRDC_Data_Usage_Report_Item = {
	"MRDC-Data-Usage-Report-Item",
	"MRDC-Data-Usage-Report-Item",
	&asn_OP_SEQUENCE,
	asn_DEF_MRDC_Data_Usage_Report_Item_tags_1,
	sizeof(asn_DEF_MRDC_Data_Usage_Report_Item_tags_1)
		/sizeof(asn_DEF_MRDC_Data_Usage_Report_Item_tags_1[0]), /* 1 */
	asn_DEF_MRDC_Data_Usage_Report_Item_tags_1,	/* Same as above */
	sizeof(asn_DEF_MRDC_Data_Usage_Report_Item_tags_1)
		/sizeof(asn_DEF_MRDC_Data_Usage_Report_Item_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_MRDC_Data_Usage_Report_Item_1,
	5,	/* Elements count */
	&asn_SPC_MRDC_Data_Usage_Report_Item_specs_1	/* Additional specs */
};
