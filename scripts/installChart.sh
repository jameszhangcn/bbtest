...
if [ $# -lt 3 ]  ; then  
       	echo "usage: $0  [bbtest] [image_repo_IP:port] [ubuntu] [couchdbip] [cdmip] " 
        echo "such as $0 bbtest 10.2.11.31:5000 rhel8 10.2.3.26"
		echo "image_repo_IP:port sample, 10.2.11.31:5000 "
		echo "[rhel8|centos7] is hostos, default is ubuntu if not input"
